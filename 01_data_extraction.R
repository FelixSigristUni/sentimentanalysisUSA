...
api_key <- api_key_data$V1[2]
base_url <- "https://content.guardianapis.com/search"
query_params <- list(
  q = "Trump AND Putin OR USA AND Russia", # to make the search more robust and specific
  "order-by" = "newest",
  "page-size" = 200,
  "api-key" = api_key,
  "show-fields" = "body"
...
# Save to CSV
write.csv(articles_df, "USA_articles.csv", row.names = FALSE)
